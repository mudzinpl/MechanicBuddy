...
namespace MechanicBuddy.Core.Persistence.Postgres.Repositories
{
    ...
    public class WorkMapping : ClassMap<Work>
    {
        public WorkMapping()
        {
            ...
            Map(x => x.EstimateSystem).Column("estimatesystem").Access.BackingField();
            Map(x => x.EstimateVersion).Column("estimateversion").Access.BackingField();
            Map(x => x.EstimatePreparedOn).Column("estimatepreparedon").Access.BackingField().CustomType<UtcDateType>();
            Map(x => x.EstimateNetAmount).Column("estimatenetamount").Access.BackingField();
            Map(x => x.EstimateVatAmount).Column("estimatevatamount").Access.BackingField();
            Map(x => x.EstimateGrossAmount).Column("estimategrossamount").Access.BackingField();
            Map(x => x.EstimateLaborMechanicalRbg).Column("estimatelabormechanicalrbg").Access.BackingField();
            Map(x => x.EstimateLaborPaintRbg).Column("estimatelaborpaintrbg").Access.BackingField();
            Map(x => x.EstimateStatus).Column("estimatestatus").Access.BackingField();
            Map(x => x.EstimateAcceptedOn).Column("estimateacceptedon").Access.BackingField().CustomType<UtcDateType>();
            Map(x => x.EstimateNotes).Column("estimatenotes").Access.BackingField();
            Map(x => x.EstimateDocumentId).Column("estimatedocumentid").Access.BackingField();
            ...
            Map(x => x.InspectionMode).Column("inspectionmode").Access.BackingField();
            Map(x => x.InspectionVisitorName).Column("inspectionvisitorname").Access.BackingField();
            Map(x => x.InspectionContactPhone).Column("inspectioncontactphone").Access.BackingField();
            Map(x => x.InspectionRemoteEmail).Column("inspectionremoteemail").Access.BackingField();
            Map(x => x.PowerOfAttorneyPrepared).Column("powerofattorneyprepared").Access.BackingField();
            Map(x => x.PowerOfAttorneySent).Column("powerofattorneysent").Access.BackingField();
            Map(x => x.VehiclePhotosReceived).Column("vehiclephotosreceived").Access.BackingField();
            Map(x => x.DamagePhotosReceived).Column("damagephotosreceived").Access.BackingField();
            Map(x => x.RegistrationDocumentPhotoReceived).Column("registrationdocumentphotoreceived").Access.BackingField();
            Map(x => x.DrivingLicencePhotoReceived).Column("drivinglicencephotoreceived").Access.BackingField();
