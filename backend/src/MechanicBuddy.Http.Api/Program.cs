...
using MechanicBuddy.Core.Application.Extensions.Builder;
using MechanicBuddy.Core.Application.Extensions.DependencyInjection;
...
app.UseSwaggerUI(c =>
{
	...
	c.SwaggerEndpoint("/swagger/v1/swagger.json", "MechanicBuddy API V1");
